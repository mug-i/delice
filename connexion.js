...
const createDatabase = async (connectionPromise) => {
  ...
  await connection.exec(
    `CREATE TABLE type_utilisateur(
		...
		INSERT INTO etat_commande(nom) VALUES('préparation');
		...
		INSERT INTO produit(nom, chemin_image, prix) VALUES
            ('Double Burger', './img/double-burger.jpg', 15.75),
            ('Burrito', './img/Burrito.jpg', 16.25),
            ('Sandwich', './img/Sandwich-au-poulet.jpg', 13.99),
            ('Pizza', './img/Pizza-méditerranéenne.jpg', 19.35),
            ('Tacos', './img/Tacos.jpg', 11.55),
            ('Wrap au poulet', './img/wrap-au-poulet.jpg', 12.99)`
  );
