  ...
  await connection.exec(
    `CREATE TABLE type_utilisateur(
		...
		INSERT INTO produit(nom, chemin_image, prix) VALUES
            ('Black T-Shirt', './img/blackShirt.jpg', 15.75),
            ('Pant', './img/pant.jpg', 33.25),
            ('Chemise', './img/shits.jpg', 20.15),
            ('T-shirt trad', './img/tradshirt.jpg', 30.45),
            ('T-shirt blanc', './img/whiteShirt.jpg', 11.55),
            ('T-shirt pavillon', './img/pavillon.jpg', 12.99)`
  );
